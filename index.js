...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const frendsowner = ["6282237416678@s.whatsapp.net"] // GAUSAH DIGANTI!!!
			...
			case 'owner':
                 ...
                 tod = await getBuffer(`https://i.ibb.co/n6R5KFf/Takimoto-Hifumi.jpg`)
            ...
            break
					...
					break
				       ...
				       if (!isOwner) return reply(mess.only.ownerB)
                                       ...
                                       if (args[0].startsWith('88212131731')) return reply('Gagal tidak dapat menelpon nomer bot')
                                       if (args[0].startsWith('81352445558')) return reply('Gagal tidak dapat menelpon nomer owner')
                ...
                case 'quotemaker':
					...
					break
				case 'galaxtext':
					if (args.length < 1) return reply('mau apa om. kentu?')
					teks = body.slice(11)
				...
				case 'testing2':
					...
					break
                case 'ninjalogo':
                      if (args.length < 1) return reply('Teks nya mana anjing?')
